    ...
    Statement = [
      {
        Effect = "Allow"
        Principal = {
          Federated = "arn:aws:iam::008872613488:oidc-provider/token.actions.githubusercontent.com"
        }
        ...
        Condition = {
          ...
          "StringLike" : {
            "token.actions.githubusercontent.com:sub" : "repo:NikitaGandza/rsschool-devops-course-tasks:ref:refs/heads/*"
          }
        }
      }
    ]
